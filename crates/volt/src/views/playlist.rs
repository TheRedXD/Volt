                                ...
                                div()
                                    ...
                                    .child({
                                        div()
                                            ...
                                            .bg(rgb(track.color))
                                            .child(div().absolute().w_full().mt(Pixels::from(12.)).pl(Pixels::from(4.)).ml(Pixels::from(-4.)).bg(rgba(0x000000d0)).rounded_md().h(self.zoom.height.to_pixels(Pixels::from(16.)) - Pixels::from(18.)))
                                            .rounded_md()
                                            .border_1()
                                                ...
                                                div()
                                                    ...
                                                    .child(
                                                        div()
                                                            ...
                                                            .bg(if track.enabled { rgb(0xffffff) } else { rgba(0x00000040) })
                                                            .text_color(if track.enabled { rgba(0x000000a0) } else { rgba(0x000000d0) })
                                                            .rounded_md()
                                                            .text_xs()
                                                            .child(format!("{}", track_index + 1))
                                                            .on_mouse_up(MouseButton::Left, cx.listener(move |view, _, _, _| {
