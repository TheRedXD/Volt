                                        ...
                                        div()
                                            ...
                                            .child({
                                                div()
                                                    ...
                                                    .bg(rgb(track.color))
                                                    .child(div().absolute().w_full().mt(Pixels::from(12.)).pl(Pixels::from(4.)).ml(Pixels::from(-4.)).bg(rgba(0x000000d0)).rounded(px(5.)).h(self.zoom.height.to_pixels(Pixels::from(16.)) - Pixels::from(18.)))
                                                    .rounded_md()
                                                    .border_1()
